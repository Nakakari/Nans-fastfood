	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle">
				<div class="profile-usertitle-name"><?php echo ucfirst($this->session->userdata('nama')); ?></div>
		...
		<ul class="nav menu">
			...
			<li><a href="<?php echo base_url('/beli/pesan'); ?>"><em class="fa fa-toggle-off">&nbsp;</em> New Request</a></li>
