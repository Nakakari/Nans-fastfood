...
<head>
	...
	<link rel="icon" type="image/png" sizes="96x96" href="<?= base_url(); ?>assets/images/21.png">s
</head>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			<div class="profile-userpic">
				<img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png" class="img-responsive" alt="">
			</div>
		...
		<ul class="nav menu">
			<li class="active"><a href="<?php echo base_url('/beranda/'); ?>"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>

			<li><a href="<?php echo base_url('login'); ?>"><em class="fa fa-power-off">&nbsp;</em> Login</a></li>
		</ul>
	</div>
	<!--/.sidebar-->