...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <a href="#">
                                ...
                                <div>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque eleifend<?php echo base_url();?>assets2.</div>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Dashboard <?php echo $title;?></h1>
